...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data Ingestion completed on artifact: {data_ingestion_artifact}")
    ...
    def sync_artifact_to_s3(self):
        try:
            ...
            self.s3_sync.sync.folder_to_s3(folder = self.training_pipeline_config.artifact_dir, aws_bucket_url = aws_bucket_url)
        except Exception as e:
            raise NetworkSecurityException(e, sys)
    ...
    def sync_saved_model_to_s3(self):
        try:
            ...
            self.s3_sync.sync.folder_to_s3(folder = self.training_pipeline_config.model_dir, aws_bucket_url = aws_bucket_url)
        except Exception as e:
            raise NetworkSecurityException(e, sys)
